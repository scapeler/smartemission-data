...
*/
			...
			data.temperatureFloat={}
			data.temperatureFloat.value	= milliKelvinToCelsius(inRecord.s_temperatureambient);
			data.temperatureFloat.type		= "Float";
			data.temperature	= milliKelvinToCelsius(inRecord.s_temperatureambient)*100;
